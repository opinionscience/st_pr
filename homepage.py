...
def main():
    ...
    # fig_trend_post_channel = subplots_bar_per_day_per_cat(df_trends_channels, "date", "plateforme", ["message_id"], "color", xaxis_title = "Date", y_axis_titles =  ["posts"],  title_text = "Trend", vertical_spacing = 0, width = 1500, height = 500, marker_color = "indianred", line_color = "#273746", plot_bgcolor=None, paper_bgcolor=None, template = "plotly")
